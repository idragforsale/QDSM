...
<nav class="qsdm-navbar" id="navbar">
    <div class="qsdm-navbar-top">
        <div class="qsdm-brand">
            <a href="#" class="qsdm-logo">
                <i class="bi bi-journal-medical"></i>
            </a>
            <div class="qsdm-brand-text">
                <h1>QDSM <span> : Admin Console</span></h1>
                <p><i class="bi bi-award text-orange"></i> ระบบจัดการเอกสาร (สำหรับผู้ดูแล)</p>
            </div>
        </div>
    ...
    <div class="qsdm-menu">
        <a href="manage" class="qsdm-menu-item">
        ...
        <a href="type" class="qsdm-menu-item">
            <i class="bi bi-folder text-orange"></i>
            <span>ประเภทเอกสาร</span>
        </a>
        <a href="department" class="qsdm-menu-item">
            <i class="bi bi-house text-orange"></i>
            <span>หน่วยงาน</span>
        </a>
        <a href="stats" class="qsdm-menu-item">
            <i class="bi bi-bar-chart-line text-orange"></i>
            <span>รายงานสถิติ</span>
        </a>
        <a href="/qdsm/" class="qsdm-menu-item">
            <i class="bi bi-people text-orange"></i>
            <span>หน้าผู้ใช้งาน</span>
        </a>
    </div>
</nav>
